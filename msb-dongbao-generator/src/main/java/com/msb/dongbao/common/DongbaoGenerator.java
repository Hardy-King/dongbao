...
public class DongbaoGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\IdeaProjects\\mashibing\\msb-dongbao-mall-parent-v1\\msb-dongbao-service\\msb-dongbao-ums\\src\\main\\java");
        gc.setAuthor("goodking");
